...
#include <jni.h>
/* Header for class com_zx_audioplayerdemo_opensles_SoundTrackController */

#ifndef _Included_com_zx_audioplayerdemo_opensles_SoundTrackController
#define _Included_com_zx_audioplayerdemo_opensles_SoundTrackController
#ifdef __cplusplus
extern "C" {
#endif
/*
